      ...
      <div className="max-w-[1000px] mx-auto pb-20">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <Link to={`/admin/customers/${id}`} className="p-2 rounded-xl border border-slate-200 bg-white text-slate-500 hover:text-slate-900 hover:bg-slate-50 transition-colors">
              <ChevronLeft className="w-5 h-5" />
            </Link>
            <div>
              <h1 className="text-2xl font-black text-slate-900 tracking-tight">Edit Customer</h1>
              <p className="text-sm text-slate-500 font-medium">Emma Thompson</p>
            </div>
          </div>
            ...
            <div className="bg-white rounded-[2rem] border border-slate-200/60 shadow-sm p-8">
              ...
              <div className="mt-6 pt-6 border-t border-slate-100">
                <label className="flex items-center gap-3 cursor-pointer group">
                  <input type="checkbox" defaultChecked className="w-5 h-5 rounded border-slate-300 text-orange-600 focus:ring-orange-500 transition-all" />
            ...
            <div className="bg-white rounded-[2rem] border border-slate-200/60 shadow-sm p-8">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input 
                    type="text" 
                    defaultValue="Musterstraße 123, Apt 4B"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <select defaultValue="Germany" className="w-full pl-12 pr-4 py-3 rounded-xl bg-slate-50 border-transparent focus:bg-white focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 transition-all font-medium text-slate-900 appearance-none">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-[2rem] border border-slate-200/60 shadow-sm p-6">
              ...
              <textarea 
                ...
                defaultValue="Customer requested special packaging for all future orders."
              ></textarea>
            </div>

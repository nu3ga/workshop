            ...
            <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                {!customer ? (
                  ...
                  <button onClick={() => setCustomer(null)} className="text-xs font-bold text-rose-600 hover:text-rose-700">Remove</button>
                )}
              </div>
              ...
              {!customer ? (
                <div className="relative">
                  ...
                  <input 
                    ...
                    onKeyDown={(e) => {
                      if (e.key === 'Enter') {
                        setCustomer({ name: 'Emma Thompson', email: 'emma.t@example.com' });
                      }
                    }}
                  />
                </div>

    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center p-6 max-w-md mx-auto font-sans">
      <div className="bg-white p-8 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">Laipni lūdzam atpakaļ</h1>
          <p className="text-slate-500 mt-2 text-sm font-medium">Ievadiet savus datus, lai piekļūtu profilam</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              ...
              <input 
                ...
                defaultValue="info@balticsafety.lv"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center px-1">
              <label className="block text-xs font-bold uppercase text-slate-400 tracking-wider">Parole</label>
              <Link to="/forgot-password" class="text-xs font-bold text-orange-600 hover:text-orange-500 hover:underline transition-colors">Aizmirsi paroli?</Link>
            </div>
            <div className="relative group">
      ...
      <div className="mt-8 text-center">
        <p className="text-sm text-slate-500 font-medium">
          Nav konta? <Link to="/register" className="font-bold text-orange-600 hover:text-orange-500 hover:underline transition-colors">Reģistrēties</Link>
        </p>
      </div>
    </div>
  );
